                ...
                return Padding(
                  ...
                  child: Stack(
                    children: [
                      Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            AppInputWidgetTwo(
                              validator: (value) =>
                                  controlller.validateFirstName(value),
                              controller: controlller.fullNameController,
                            ...
                            AppInputWidgetTwo(
                              controller: controlller.emailController,
                              validator: (value) =>
                                  controlller.validateEmail(value),
                              isEmail: true,
                              borderRadius: AppSize.width(value: 8),
                              contentPadding: EdgeInsets.symmetric(
                                horizontal: AppSize.width(value: 20),
                            ...
                            if (rollSelected == Role.CLIENT.name)
                              AppInputWidgetTwo(
                                controller: controlller.phoneController,
                                validator: (value) =>
                                    controlller.validatePhoneNumber(value),
                            ...
                            AppInputWidgetTwo(
                              ...
                              validator: (value) =>
                                  controlller.validatePassword(value),
                            ...
                            AppInputWidgetTwo(
                              controller: controlller.confirmpasswordController,
                              validator: (value) =>
                                  controlller.validateRePassword(value),
                              borderRadius: AppSize.width(value: 8),
                              contentPadding: EdgeInsets.symmetric(
                                horizontal: AppSize.width(value: 20),
                              ),
                            ...
                            Obx(() {
                              return controlller.isChecked.value
                                  ? AppButton(
                                  ...
                                  : AppButton(
                                      ...
                                      title: "Sign Up",
                                      titleSize: AppSize.width(value: 18),
                                      filColor: AppColor.gold.withValues(
                                        alpha: 0.4,
                                      ),
                                    );
                            }),
                      ...
                      Positioned.fill(
                        child: Obx(() {
                          return controlller.isLoading.value
                              ? AppLoading(size: 58)
                              : SizedBox();
                        }),
                      ),
